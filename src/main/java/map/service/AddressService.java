...
import map.repository.AddressRepo;
...
public class AddressService {
    ...
    public String add(AddressDto dto) {
        ...
        if (repo.existsByTitleAndNumber(dto.getTitle(), dto.getNumber())){
            if (districtRepo.existsByTitleAndAddress(dto.getDistrictTitle().trim(), repo.getByTitleAndNumber(dto.getTitle(), dto.getNumber())))
